...
fn_twitter_CO2Gesetz <- searchTwitter("CO2-Gesetz", n=1000, since= "2021-05-01", until="2021-05-07")
fn_twitter_CO2Gesetz_df <- twListToDF(fn_twitter_CO2Gesetz) 

fn_twitter_CO2GesetzJa <- searchTwitter("#CO2GesetzJa", n=1000, since= "2021-05-01", until="2021-05-07")
fn_twitter_CO2GesetzJa_df <- twListToDF(fn_twitter_CO2GesetzJa) 

fn_twitter_JaCO2Gesetz <- searchTwitter("#JaCO2Gesetz", n=1000, since= "2021-05-01", until="2021-05-07")
fn_twitter_JaCO2Gesetz_df <- twListToDF(fn_twitter_JaCO2Gesetz) 

fn_twitter_CO2GesetzNein <- searchTwitter("#CO2GesetzNein", n=1000, since= "2021-05-01", until="2021-05-07")
fn_twitter_CO2GesetzNein_df <- twListToDF(fn_twitter_CO2GesetzNein) 

fn_twitter_NeinCO2Gesetz <- searchTwitter("#NeinCO2Gesetz", n=1000, since= "2021-05-01", until="2021-05-07")
...
export(Week_1, "Twitter_Week3.xlsx")
export(Week_1, "Twitter_Week3.csv")
